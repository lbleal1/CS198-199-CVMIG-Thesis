...
**Errata on slides:** Visualization on Bounding Boxes - the training set should only be the one visualized. This errata does not alter the resuts since the decisions were made only using the training set.
